...
def test_get_downsized_video_image_url_resolves():
    """URL /ajax/get-downsized-video-image/ should resolve via its URL name."""
    match = resolve("/ajax/get-downsized-video-image/")
    assert match.url_name == "get-downsized-video-image"


def test_get_downsized_mesh_image_url_resolves():
    """URL /ajax/get-downsized-mesh-image/ should resolve via its URL name."""
    match = resolve("/ajax/get-downsized-mesh-image/")
    assert match.url_name == "get-downsized-mesh-image"


def test_get_mesh_url_resolves():
    """URL /ajax/get-mesh/ should resolve via its URL name."""
    match = resolve("/ajax/get-mesh/")
    assert match.url_name == "get-mesh"
